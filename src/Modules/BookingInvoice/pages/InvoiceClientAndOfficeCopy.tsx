...
const InvoiceClientAndOfficeCopy = () => {
  return (
    <>
      <Breadcrumb
        className="my-5"
      ...
      <Tabs defaultActiveKey={"1"}>
        {[
          ...
          {
            component: <SingleInvoice copy={"Client Copy"} />,
            icon: FaRegUser,
            key: "1",
          },
          {
            component: <SingleInvoice copy={"Office Copy"} />,
...
export default InvoiceClientAndOfficeCopy;
